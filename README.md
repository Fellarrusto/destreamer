...
Options:
  ...
  --username, -u          The username used to log into Microsoft Stream (enabling this will fill in the email field for
                          you).                                                                                 [string]
  --p                     The password used to log into Microsoft Stream (enabling this will fill in the email field for
                          you).                                                                                 [string]
...
Download a video -
Download a video and speed up the interactive login by automagically filling in the username and password -
```sh
$ ./destreamer.sh -u user@example.com -p example_password -i "https://web.microsoftstream.com/video/VIDEO-1"
```
